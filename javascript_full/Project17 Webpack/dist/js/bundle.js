...
function timer() {
  var deadline = '2020-01-28';

  function getTimeRemaining(endtime) {
    var t = Date.parse(deadline) - Date.parse(new Date()),
        seconds = Math.floor(t / 1000 % 60),
        minutes = Math.floor(t / 1000 / 60 % 60),
        hours = Math.floor(t / (1000 * 60 * 60)); // hours = ((t / 1000 / 60 / 60) % 24);
...
__webpack_require__(/*! nodelist-foreach-polyfill */ "./node_modules/nodelist-foreach-polyfill/index.js"); // require('es6-promise').polyfill();
